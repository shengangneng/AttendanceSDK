...
- (void)setupConstraints {
    ...
    [self.detailTitleLabel mpm_makeConstraints:^(MPMConstraintMaker *make) {
        make.leading.equalTo(self.iconImageView.mpm_trailing).offset(15);
        make.top.equalTo(self.iconImageView.mpm_top);
        make.width.equalTo(@100);
        make.height.equalTo(@20);
    }];
    [self.detailMessageImageView mpm_makeConstraints:^(MPMConstraintMaker *make) {
        make.leading.equalTo(self.iconImageView.mpm_trailing).offset(10);
        make.top.equalTo(self.detailTitleLabel.mpm_bottom);
        make.trailing.equalTo(self.mpm_trailing).offset(-14);
        make.height.equalTo(@50);
    }];
    [self.detailMessageIcon mpm_makeConstraints:^(MPMConstraintMaker *make) {
        make.leading.equalTo(self.detailMessageImageView.mpm_leading).offset(15);
        make.top.equalTo(self.detailMessageImageView.mpm_top).offset(8);
        make.width.height.equalTo(@13);
    }];
    [self.detailMessageName mpm_makeConstraints:^(MPMConstraintMaker *make) {
        make.leading.equalTo(self.detailMessageImageView.mpm_leading).offset(36);
        make.centerY.equalTo(self.detailMessageIcon.mpm_centerY);
        make.height.equalTo(@25);
    }];
    [self.detailMessageTime mpm_makeConstraints:^(MPMConstraintMaker *make) {
        make.trailing.equalTo(self.detailMessageImageView.mpm_trailing).offset(-5);
        make.centerY.equalTo(self.detailMessageIcon.mpm_centerY);
        make.height.equalTo(@25);
    }];
    [self.detailMessageDetailText mpm_makeConstraints:^(MPMConstraintMaker *make) {
        make.leading.equalTo(self.detailMessageImageView.mpm_leading).offset(36);
        make.top.equalTo(self.detailMessageName.mpm_bottom);
        make.trailing.equalTo(self.detailMessageImageView.mpm_trailing).offset(-10);
        make.height.equalTo(@25);
    }];
}
