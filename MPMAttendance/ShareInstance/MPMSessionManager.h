...
@property (nonatomic, strong) MPMHTTPSessionManager *manager;

+ (instancetype)shareManager;

/** 在后台线程监控网络状态 */
- (void)startNetworkMonitoringWithStatusChangeBlock:(void(^)(MPMNetworkReachabilityStatus status))block;
