...
#define kJiFenType1NameFromId @{@"0":@"改签",@"1":@"补签",@"4":@"加班",@"3":@"出差",@"2":@"请假",@"5":@"外出"}
#define kJiFenType0DescriptionFromId @{@"0":@"每次在正常上班的(排班点)打卡奖分",@"5":@"每次在正常下班的(排班点)打卡奖分",@"4":@"每次在正常上班点前(30分钟)打卡奖分",@"1":@"每次在超过(排班点)后打卡扣分",@"2":@"每次在正常下班的(排班点)前打卡扣分",@"3":@"在正常上下班的(60分钟)未打卡扣分"}
#define kJiFenType1DescriptionFromId @{@"0":@"每次在正常上下班对(排班点)改签奖扣分",@"1":@"每次在正常上下班(排班点)补签奖扣分",@"4":@"按每小时奖分",@"3":@"按每小时奖分",@"2":@"按每小时奖扣分",@"5":@"按每小时奖扣分"}
// 重置的积分（默认积分）
