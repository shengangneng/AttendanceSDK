...
#define kJiFenType0DescriptionFromId @{@"0":@"每次在正常上班的(排班点)打卡奖分",@"5":@"每次在正常下班的(排班点)打卡奖分",@"4":@"每次在正常上班点前(30分钟)打卡奖分",@"1":@"在超过(排班点)后打卡扣分",@"2":@"在正常下班的(排班点)前打卡扣分",@"3":@"在正常上下班的(60分钟)未打卡扣分"}
