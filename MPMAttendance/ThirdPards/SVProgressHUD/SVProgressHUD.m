...
- (instancetype)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        _infoImage = [UIImage imageNamed:[@"SVProgressHUD.bundle" stringByAppendingPathComponent:@"info"]];
        _successImage = [UIImage imageNamed:[@"SVProgressHUD.bundle" stringByAppendingPathComponent:@"success"]];
        _errorImage = [UIImage imageNamed:[@"SVProgressHUD.bundle" stringByAppendingPathComponent:@"error"]];
